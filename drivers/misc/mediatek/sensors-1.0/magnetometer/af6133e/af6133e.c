...
static int af6133e_mag_temp_comp(int16_t *mag_data)
{
  ...
  if(af6133e_odr > 0 && af6133e_t_count++ > af6133e_odr)
  {
    ...
    af6133e_t_buf[af6133e_t_index] = (int16_t)((int32_t)af6133e_t_buf[af6133e_t_index] * TEMP_RESOLUTION) / 1000;
...
static int __init af6133e_init(void)
{
  int err;
	...
	int ret = 0;
	const char *name = "mediatek,af6133e";
	printk("af6133_init\n");
