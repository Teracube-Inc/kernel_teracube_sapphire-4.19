...
#define HWOCV_OLDOCV_DIFF_CHR		1200
#define SWOCV_OLDOCV_DIFF			300
#define SWOCV_OLDOCV_DIFF_CHR		1200
...
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4201, 2712, 2490, 1965},/*T0*/
	{ 4248, 2851, 2468, 1984},/*T1*/
	{ 4264, 2432, 2310, 1946},/*T2*/
	{ 4195, 1991, 1858, 1873},/*T3*/
	{ 4220, 1960, 1843, 1851},/*T4*/
...
int g_Q_MAX_H_CURRENT[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4179, 2412, 2190, 1665},/*T0*/
	{ 4226, 2551, 2168, 1684},/*T1*/
	{ 4188, 2132, 2010, 1646},/*T2*/
	{ 3930, 1691, 1558, 1573},/*T3*/
	{ 3566, 1660, 1543, 1551},/*T4*/
